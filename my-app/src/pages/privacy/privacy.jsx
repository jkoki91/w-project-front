        ...
        <React.Fragment>
            ...
            <Col className={`ps-5 pt-3 mb-0 pe-5 className text-${theme.leters} bg-${theme.background}`}>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to DeloreanFL.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        {/* <p><strong>Website</strong> refers to DeloreanFL, accessible from <a href="http://localhost:3000/" rel="external nofollow noopener" target="_blank">http://localhost:3000/</a></p> */}
                        <p><strong>Website</strong> refers to DeloreanFL, accessible from <a href="http://localhost:3000/" rel="external nofollow noopener" target="_blank">http://localhost:3000/</a></p>
                    </li>
                    <li>
